    ...
    protected function respondWithToken($token)
    {
        ...
        return response()->json([
            ...
            'user' => [
                ...
                "role_name" => optional(auth("api")->user()->role)->name, // Evitar error si no tiene rol
                "permissions" => $permissions,
                "sucursale_id" => auth('api')->user()->sucursale_id,
                "sucursale_name" => optional(auth('api')->user()->sucursale)->name, // Evitar error si no tiene sucursal
            ]
        ]);
    }
}
